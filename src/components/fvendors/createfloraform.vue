        ...
        <v-layout>
            <v-flex xs12 sm6 offset-sm3 class="main" >
                <v-card elevation="19" class="card">
                    <v-container>
                        <v-layout row>
                            <v-flex class="text-center font-weight-black"><h1 class="font-weight-black text-center">flora & deco (featured) basic information</h1></v-flex>
                        </v-layout>
                        
                        <v-form @submit.prevent="createflora">
                            <v-layout row>
                            ...
                            <v-layout row>                         <v-flex>
                                    ...
                                    v-model="flora_location"
                                    solo
                                    :items="districts" 
                                    prepend-icon="mdi-earth"
                                    label="flora location">
                                    </v-select>
                                </v-flex>
          ...
          <v-select class="mr-6 ml-3"
            v-model="flora_categories"
            :items="items"
          
            label="Type of flora"
       
            prepend-icon="mdi-flora"
          ></v-select>
        </v-col>
                                </v-flex>
                        ...
                        <!--     <v-layout row>                         <v-flex>
                                    ...
                                    v-model="flora_capacity"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-table-chair"
                                    label="flora seating capacity">
                                    </v-text-field>
                                </v-flex>
                            ...
                            <v-layout row>                         
                                <v-flex>
                                    <v-text-field class="mr-6 ml-6"
                                    v-model="flora_contact_website"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-earth"
                                    label="flora official site">
                                    </v-text-field>
                                </v-flex>
...
export default {
    ...
    data () {
        return {
            ...
            pricemin: '',
            pricemax: '',
            items: ['Structures','Wedding flora','Cupflora','Structures & Wedding flora','Structures & Cupflora', 'Cupflora & Wedding flora', 'All kinds'],
            districts: ['Galle',
                    'Colombo',
                    'Gampaha',
                    'Hambantota',
    ...
    methods: {
        ...
        createflora () {
            ...
            this.imgurl,
            this.flora_contact,
            this.flora_description,
            this.flora_hall)

            this.$store.dispatch('f_ad_flora', {name: this.flora_name, 
                
                location: this.flora_location,
                contact: this.flora_contact,
                description: this.flora_description,
                website: this.flora_contact_website,
                email: this.flora_contact_email,
                 imgurl: this.img1,
                imgurl1: this.img6,
                imgurl2: this.img2,
                imgurl3: this.img3,
                imgurl4: this.img4,
                imgurl5: this.img5,
                // category: this.flora_categories,
