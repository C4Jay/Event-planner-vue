        ...
        <v-layout>
            <v-flex xs12 sm6 offset-sm3 class="main" >
                <v-card elevation="19" class="card">
                    <v-container>
                        <v-layout row>
                            <v-flex class="text-center font-weight-black display-1">cards/gifts (featured) basic information</v-flex>
                        </v-layout>
          ...
          <v-select class="mr-6 ml-3"
            v-model="card_categories"
            :items="items"
          
            label="Type of cards/gifts"
          ...
          ></v-select>
                        ...
                        <!--     <v-layout row>                         <v-flex>
                                    ...
                                    v-model="card_capacity"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-table-chair"
                                    label="card seating capacity">
                                    </v-text-field>
                                </v-flex>
                            ...
                            <v-layout row>                         
                                <v-flex>
                                    <v-text-field class="mr-6 ml-6"
                                    v-model="card_contact_website"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-earth"
                                    label="card official site">
                                    </v-text-field>
                                </v-flex>
...
export default {
    ...
    data () {
        return {
            ...
            pricemin: '',
            pricemax: '',
            items: ['Structures','Wedding card','Cupcard','Structures & Wedding card','Structures & Cupcard', 'Cupcard & Wedding card', 'All kinds'],
            districts: ['Galle',
                    'Colombo',
                    'Gampaha',
                    'Hambantota',
    ...
    methods: {
        ...
        createcard () {
            ...
            this.$store.dispatch('f_ad_card', {name: this.card_name, 
                
                location: this.card_location,
                contact: this.card_contact,
                description: this.card_description,
                website: this.card_contact_website,
                email: this.card_contact_email,
                  imgurl: this.img1,
                imgurl1: this.img6,
                imgurl2: this.img2,
                imgurl3: this.img3,
