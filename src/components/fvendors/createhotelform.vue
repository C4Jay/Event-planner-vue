        ...
        <v-layout>
            <v-flex xs12 sm6 offset-sm3 class="main" >
                <v-card elevation="19" class="card">
                    <v-container>
                        <v-layout row>
                            <v-flex class="text-center font-weight-black"><h1 class="font-weight-black text-center">hotel (featured) basic information</h1></v-flex>
                        </v-layout>
...
export default {
    ...
    methods: {
        ...
        createhotel () {
            ...
            this.$store.dispatch('f_ad_hotel', {name: this.hotel_name, 
