        ...
        <v-layout>
            <v-flex xs12 sm6 offset-sm3 class="main" >
                <v-card elevation="19" class="card">
                    <v-container>
                        <v-layout row>
                            <v-flex class="text-center font-weight-black"><h1 class="font-weight-black text-center">cake (featured) basic information</h1></v-flex>
                        </v-layout>
                        
                        <v-form @submit.prevent="createcake">
                            <v-layout row>
          ...
          ></v-select>
                        ...
                        <!--     <v-layout row>                         <v-flex>
                                    ...
                                    v-model="cake_capacity"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-table-chair"
                                    label="cake seating capacity">
                                    </v-text-field>
                                </v-flex>
                            ...
                            <v-layout row>                         
                                <v-flex>
                                    <v-text-field class="mr-6 ml-6"
                                    v-model="cake_contact_website"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-earth"
                                    label="cake official site">
                                    </v-text-field>
                                </v-flex>
...
export default {
    ...
    data () {
        return {
            ...
            pricemin: '',
            pricemax: '',
            items: ['Structures','Wedding Cake','Cupcake','Structures & Wedding Cake','Structures & Cupcake', 'Cupcake & Wedding Cake', 'All kinds'],
            districts: ['Galle',
                    'Colombo',
                    'Gampaha',
                    'Hambantota',
    ...
    methods: {
        ...
        createcake () {
            ...
            this.$store.dispatch('f_ad_cake', {name: this.cake_name, 
                
                location: this.cake_location,
                contact: this.cake_contact,
                description: this.cake_description,
                website: this.cake_contact_website,
                email: this.cake_contact_email,
                  imgurl: this.img1,
                imgurl1: this.img6,
                imgurl2: this.img2,
                imgurl3: this.img3,
