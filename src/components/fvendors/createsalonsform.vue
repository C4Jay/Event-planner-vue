        ...
        <v-layout>
            <v-flex xs12 sm6 offset-sm3 class="main" >
                <v-card elevation="19" class="card">
                    <v-container>
                        <v-layout row>
                            <v-flex class="text-center font-weight-black display-1">salon (featured) basic information</v-flex>
                        </v-layout>
                        
                        <v-form @submit.prevent="createsalon">
                            <v-layout row>
          ...
          <v-select class="mr-6 ml-3"
            v-model="salon_categories"
            :items="items"
          
            label="Type of salon"
       
            prepend-icon="mdi-salon"
          ></v-select>
        </v-col>
                                </v-flex>
                        ...
                        <!--     <v-layout row>                         <v-flex>
                                    ...
                                    v-model="salon_capacity"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-table-chair"
                                    label="salon seating capacity">
                                    </v-text-field>
                                </v-flex>
                            ...
                            <v-layout row>                         
                                <v-flex>
                                    <v-text-field class="mr-6 ml-6"
                                    v-model="salon_contact_website"
                                    solo
                                    type="text" 
                                    prepend-icon="mdi-earth"
                                    label="salon official site">
                                    </v-text-field>
                                </v-flex>
...
export default {
    ...
    data () {
        return {
            ...
            pricemin: '',
            pricemax: '',
            items: ['Structures','Wedding salon','Cupsalon','Structures & Wedding salon','Structures & Cupsalon', 'Cupsalon & Wedding salon', 'All kinds'],
            districts: ['Galle',
                    'Colombo',
                    'Gampaha',
                    'Hambantota',
    ...
    methods: {
        ...
        createsalon () {
            ...
            this.$store.dispatch('f_ad_salon', {name: this.salon_name, 
                
                location: this.salon_location,
                contact: this.salon_contact,
                description: this.salon_description,
                website: this.salon_contact_website,
                email: this.salon_contact_email,
                 imgurl: this.img1,
                imgurl1: this.img6,
                imgurl2: this.img2,
                imgurl3: this.img3,
                imgurl4: this.img4,
                imgurl5: this.img5,
                // category: this.salon_categories,
