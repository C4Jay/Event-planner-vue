...
export default {
    ...
    mounted () {
        ...
        this.wholeResponse = this.$store.getters.photographysfind(this.id)
        console.log(this.wholeResponse.img)
        console.log(this.wholeResponse.categories)
        ...
        this.category0 = this.wholeResponse.categories[0]
        this.category1 = this.wholeResponse.categories[1]
    },

    computed: {
        item() {
            return this.$store.getters.photographysfind(this.id)
        }
    }
