    ...
    <v-container grid-list-lg>
        <v-layout row wrap >
            <v-flex xs12 sm12 md3 v-for="item in items" :key="item.id">
                <v-card :to="'/bridalwear/' + item.id" v-if="(location == '' || location == item.location ) && (category == '' || item.category == 'All kinds' || category == item.category )" elevation="19">
                    <v-responsive>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <pre>{{item.weddinglist}}</pre>
                            
                              

                            <h3 class="text-weight-black">Homecoming dresses</h3>
                            <pre>{{item.homecominglist}}</pre>
